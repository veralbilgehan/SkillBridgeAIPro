...
Bu vaka, birden fazla uzmanlık alanını ve sertifika bilgisini aynı anda gerektiren karmaşık, teknik detaylarla dolu bir vaka olmalıdır. Çıktı sadece vaka metni (düz metin) olmalıdır.`;
        ...
        try {
            ...
            <div class="case-card-actions">
                ...
                <button class="primary" onclick="state.pendingCase = document.getElementById('db-case-text').value; go('questions')">Soru Üret & Test Hazırla →</button>
            </div>`;
            
            state.pendingCase = resultText;
        } catch(e) {
            toast('Hata: ' + e.message);
        } finally {
            aiBusy(button, false);
