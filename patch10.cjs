...
if (!app.includes('PATCH 10: LEDGER')) {
    fs.writeFileSync('dist/patch10.js', patchCode, 'utf8');
    app += '\n' + patchCode;
    fs.writeFileSync('dist/app.js', app, 'utf8');
    console.log('Patch 10 injected successfully!');
} else {
    console.log('Patch 10 already injected.');
}
